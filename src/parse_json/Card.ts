// github.com/kiootic/pad-rikuu/blob/bd1d44eb4b2d0aabb82b15bb5c2c09afe1a988b2/src/models/Card.ts
// import { Curve } from "src/models/Curve";

// 火、水、木、光、闇、無
export type Attr = "fire" | "water" | "wood" | "light" | "dark" | "null";
...
export namespace Card {
    ...
    //     function curve(
    //         c: Curve | { min: number; max?: number; scale?: number }
    //     ) {
    ...
    //             value += c.max
    //                 ? c.max * (card.limitBreakIncr / 100) * (exceed / 11)
    //                 : c.min * exceed;
    //         }
    //         return value;
    //     }
    ...
    //         rcv: curve(card.rcv),
    //         exp:
    //             Curve.valueAt(level, card.maxLevel, card.exp) +
